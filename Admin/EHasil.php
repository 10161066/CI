...
<div class="card">
	<div class="container">
		...
		?>
		<form method="post" action="btnHasil.php?Tanggal=<?php echo $Tanggal; ?>" enctype="multipart/form-data">
			<p class="h4 text-center py-4">Ubah Data Produksi</p>
			<div class="md-form">
				<i class="fa fa-id-card-o prefix grey-text"></i>
				<input type="number" name="No" placeholder="No" value="<?php echo $data['No'] ?>">
			</div>
			<div class="md-form">
				<i class="fa fa-id-card-o prefix grey-text"></i>
